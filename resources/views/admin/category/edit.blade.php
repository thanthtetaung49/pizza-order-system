      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-3 offset-8">
            <a href="{{ route('category#listPage') }}"><button class="btn btn-lg bg-dark text-white my-3">List</button></a>
          </div>
        </div>
        <div class="col-lg-6 offset-3">
          <div class="card">
            <div class="card-body">
              ...
              <hr>
              <form action="{{ route('category#edit', $data->id) }}" method="POST" novalidate="novalidate">
                @csrf
                <div class="form-group">
                  ...
                  <input class="form-control @error('categoryName') is-invalid @enderror" id="category"
                         name="categoryName" type="text" value="{{ old('categoryName', $data->name) }}"
                ...
                <div class="d-grid mt-3">
                  <button class="btn btn-lg btn-info btn-block" id="category-button" type="submit">
                    <span id="category-button-amount">Edit</span>
