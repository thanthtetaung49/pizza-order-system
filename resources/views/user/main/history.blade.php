              ...
              @foreach ($orders as $order)
                <tr>
                  ...
                  <td class="align-middle">
                    @if ($order->status == 0)
                         <span class="text-warning"><i class="fa-regular fa-hourglass-half me-2"></i>Pending...</span>
                    @elseif ($order->status == 1)
                         <span class="text-success"><i class="fa-solid fa-circle-check me-2"></i>Success...</span>
                    @else
                         <span class="text-danger"><i class="fa-solid fa-circle-xmark me-2"></i>Rejected...</span>
                    @endif
                  </td>
                </tr>
              @endforeach
